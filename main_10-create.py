...
In this version, I'm noticing that adding a definition to a word should be part of updating a definition.

Adding a word can then just create a word in the dictionary and update the definition for that word with an add.

If we do that... when a word has no definitions, we don't need to ask of we want to add or change an existing definition.
